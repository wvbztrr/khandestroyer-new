...
class UI {
  static init() {
    ...
    Object.assign(_0x3d849d.style, {
      ...
      right: "15px",
      width: "200px",
      background: "linear-gradient(145deg,rgb(0, 0, 0), #111)",
      borderRadius: "12px",
      display: "flex",
    ...
    _0x3d849d.innerHTML = `
            ...
            <div class="khandestroyer-content">
                ...
                <div class="khandestroyer-credit">by iUnknownBr | remade by wbztrr</div>
            </div>
        `;
    ...
    document.getElementById("autoCheck").onchange = event => {
      ...
      sendToast(APP.cfg.auto ? "✅ Completar automático ligado" : "❌ Completar automático desligado", 2000);
    };
    ...
    document.getElementById("spoofCheck").onchange = event => {
      ...
      sendToast(APP.cfg.questionSpoof ? "✅ Spoofer ativado" : "❌ Spoofer desativado", 2000);
    };
...
class Core {
  ...
  static setupMod() {
    const messages = [
      "made by [@wbztrr](https://instagram.com/wbztrr)."
    ];
